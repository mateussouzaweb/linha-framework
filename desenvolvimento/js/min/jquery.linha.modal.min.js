...
m.fecha=$('<span>x</span>').addClass(o.classeFecha);m.titulo=$('<div></div>').addClass(o.classeTitulo);m.conteudo=$('<div></div>').addClass(o.classeConteudo);m.load.css({marginTop:-(m.load.outerHeight()/2),marginLeft:-(m.load.outerWidth()/2)});if($.isFunction(o.onCria)){o.onCria.apply(m.modal,new Array(m,el,$t,o));}}
