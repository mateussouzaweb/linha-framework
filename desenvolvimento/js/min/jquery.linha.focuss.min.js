...
$t.css({borderColor:o.cor});if($.isFunction(o.onInicia)){o.onInicia.apply($t,new Array($t,texto,o));}}
function terminaFocuss($t,bcor,texto){if(o.removeTexto){if($t.val()==''){$t.val(texto);}}
$t.css({borderColor:bcor});if($.isFunction(o.onTermina)){o.onTermina.apply($t,new Array($t,bcor,texto,o));}}};})(jQuery);