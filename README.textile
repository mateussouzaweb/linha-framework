...
p. Basicamente é feito uma checagem em um intervalo determinado tem tempo para a chegagem.
...
p. Se desejar alterar, a opção é "liveTempo", mais lembre-se que deve ser em milisegundos.
...
p. Para melhor esclarecimento, o *MONITORAMENTO LIVE* é necessário em alguns plugins pois eles necessitam de um "setup" antes de entrar em uso, o que já não ocorre em um plugin LIVE. Sendo um pouco mais prático um accordion precisa de um "setup", ou seja, definir qual parte do accordion será a inicial e etc. Já um tooltip não precisa, pois o setup é feito assim que ele é disparado.
