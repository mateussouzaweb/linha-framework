 ...
 * jQuery Focus 1.2
 */
(function(a){a.fn.focuss=function(b){function d(b,c){f.removeTexto&&b.val()==c&&b.val(""),b.addClass(f.classe),a.isFunction(f.onInicia)&&f.onInicia.apply(b,[b,c,f])}function c(b,c){f.removeTexto&&b.val()==""&&b.val(c),b.removeClass(f.classe),a.isFunction(f.onTermina)&&f.onTermina.apply(b,[b,c,f])}var e={evento:"focus",eventoFim:"blur",classe:"focus",removeTexto:!1,onInicia:null,onTermina:null,live:!1,liveTempo:100},f=a.extend(e,b),g=this.selector,h=[];a(document).delegate(g,"iniciaFocuss",function(){var b=a(g).not(h);h=a(g),b.each(function(){var b=a(this),e=a(this).val();b.bind(f.evento,function(){return d(b,e)}),b.bind(f.eventoFim,function(){return c(b,e)})})}),f.live?setInterval(function(){a(g).trigger("iniciaFocuss")},f.liveTempo):this.length&&this.trigger("iniciaFocuss")}})(jQuery),
 ...
 */
(function(a){a.fn.slideTabs=function(b){var c={seletorAreaPainel:".slide-conteudo",seletorPainel:".painel",seletorMiniatura:".miniatura",seletorAnterior:".anterior",seletorProximo:".proximo",classeMiniatura:"slide-miniatura-atual",classePainel:"slide-painel-atual",classePainelPrimeiro:"slide-painel-primeiro",classePainelUltimo:"slide-painel-ultimo",classePainelConteudo:"slide-painel-conteudo",eventoMiniatura:"click",eventoSeta:"click",hash:!1,hashPrefixo:"slide-",inicial:1,continuo:!0,auto:!1,pausarAuto:!0,pausa:2e3,tempo:"normal",easing:"swing",alturaAutomatica:!1,margin:!0,scroll:1,visiveis:1,direcao:"x",onSlide:null,live:!1,liveTempo:100},d=a.extend(c,b),e=this.selector,f=window.location.hash,g=[];f!=""&&(f="#"+d.hashPrefixo+f.substr(1)),a(document).delegate(e,"iniciaSlideTabs",function(){var b=a(e).not(g);g=a(e),b.each(function(){function c(c){var l=a("."+i,e).prevAll().length+d.scroll;f.removeClass(j);if(f.length-l<=d.visiveis)if(f.eq(-1).hasClass(k)){f.removeClass(k);if(d.continuo)l=0,f.eq(0).addClass(j);else return!1}else l=f.length-d.visiveis,f.eq(-1).addClass(k);f.removeClass(i).eq(l).addClass(i),g.removeClass(h).eq(l).addClass(h);return b(c,l)}function b(b,g){a.isFunction(d.onSlide)&&d.onSlide.apply(e,[e,b,p,g,d]);var h=q.height();d.alturaAutomatica&&o&&(h=f.eq(g).outerHeight());var i={};i[o?"marginLeft":"marginTop"]=-p[g]+"px",i.height=h,q.animate(i,d.tempo,d.easing),clearInterval(n),d.auto&&(n=setInterval(function(){if(d.pausarAuto&&e.data("slideHover"))return!1;return c(null)},d.pausa));return!1}var e=a(this),f=a(d.seletorPainel,e),g=a(d.seletorMiniatura,e),h=d.classeMiniatura,i=d.classePainel,j=d.classePainelPrimeiro,k=d.classePainelUltimo,l=0,m=d.inicial-1,n,o=d.direcao=="x",p={};e.children(d.seletorAreaPainel).wrapInner('<div class="'+d.classePainelConteudo+'"></div>');var q=a("."+d.classePainelConteudo,e);f.each(function(b){p[b]=l,l+=a(this)[o?"outerWidth":"outerHeight"](d.margin)}),q.css(o?"width":"height",l).css("overflow","hidden"),q.css(o?"marginLeft":"marginTop",-p[m]),d.alturaAutomatica&&o&&q.css("height",f.eq(m).outerHeight(d.margin)),f.eq(m).addClass(i),g.eq(m).addClass(h),m==0&&f.eq(0).addClass(j),m==f.length-1&&f.eq(-1).addClass(k),g.bind(d.eventoMiniatura,function(){var c=a(this).prevAll(d.seletorMiniatura).length;g.removeClass(h),f.removeClass(i).removeClass(j).removeClass(k),a(this).addClass(h),f.eq(c).addClass(i),c==0&&f.eq(0).addClass(j),c==f.length-1&&f.eq(-1).addClass(k),this.hash&&(window.location.hash=this.hash);return b(a(this),c)}),a(d.seletorAnterior,e).bind(d.eventoSeta,function(){var c=a("."+i,e).prevAll().length-d.scroll;f.removeClass(k);if(c<=0)if(f.eq(0).hasClass(j)){f.removeClass(j);if(d.continuo)c=f.length-d.visiveis,f.eq(-1).addClass(k);else return!1}else c=0,f.eq(0).addClass(j);f.removeClass(i).eq(c).addClass(i),g.removeClass(h).eq(c).addClass(h),this.hash&&(window.location.hash=this.hash);return b(a(this),c)}),a(d.seletorProximo,e).bind(d.eventoSeta,function(){this.hash&&(window.location.hash=this.hash);return c(a(this))}),d.auto&&d.pausarAuto&&e.hover(function(){a(this).data("slideHover","1")},function(){a(this).removeData("slideHover")}),d.auto&&(n=setInterval(function(){return c(null)},d.pausa))})}),d.hash&&f!=""&&a(f).is(d.seletorPainel)&&(d.inicial=a(f).prevAll(d.seletorPainel).length+1),d.live?setInterval(function(){a(e).trigger("iniciaSlideTabs")},d.liveTempo):this.length&&this.trigger("iniciaSlideTabs")}})(jQuery),
