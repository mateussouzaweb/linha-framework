 ...
 * Aprenda a usar o Sass & Terminal - ESSÊNCIAL
...
CHANGELOG
=====================
#### 1.3 - XX de XXXXXXXX de 2014 (em constante desenvolvimento...)
 ...
 * Removido plugins Linha Acord, Modal, SlideTabs e Tooltip - Os mesmo serão re-introduzidos com mais compatibilidade em futuras versões
 * Atualização jQuery para V. 2.0.3
